...
class PowerUpSystem {
    ...
    applyEffect(powerUp, gameEngine) {
        switch (powerUp.effect) {
            ...
            case 'addLife':
                // Don't add lives in survival mode - survival should have only one life
                if (gameEngine.state.gameMode !== 'survival') {
                    gameEngine.state.lives += powerUp.value;
                }
                return true;

            case 'secondChance':
                // Don't activate second chance in survival mode - should have only one life
                if (gameEngine.state.gameMode !== 'survival') {
            ...
            case 'shield':
                // Don't activate shield in survival mode - should have only one life
                if (gameEngine.state.gameMode !== 'survival') {
