...
class AudioSystem {
    constructor() {
        ...
        this.sfxVolume = 0.7;
        this.musicEnabled = true; // Música ligada por padrão
    ...
    createMusic() {
        ...
        this.musicTracks = {
            // Frequências mais baixas e suaves
            menu: this.createAmbientTrack([130.81, 164.81, 196, 261.63], 0.05),
            gameplay: this.createAmbientTrack([110, 138.59, 164.81, 220], 0.08),
            zen: this.createAmbientTrack([87.31, 110, 130.81, 164.81], 0.03)
        };
    }
